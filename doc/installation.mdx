...
seo:
  title: 'Install Cristalyse - Flutter Data Visualization Library Setup Guide'
  description: 'Step-by-step installation guide for Cristalyse Flutter chart library. Add grammar of graphics data visualization to your Flutter project in seconds.'
  keywords: 'install cristalyse, flutter chart library installation, add cristalyse flutter, flutter visualization setup, pub.dev cristalyse'
  canonical: 'https://docs.cristalyse.com/installation'
---
...
dependencies:
  flutter:
    sdk: flutter
  cristalyse: ^1.17.3  # Latest version
```
